<script>
	...
	$(document).ready(function() {
		...
		$('#form_add').on('submit', function(e) {
			...
			$.ajax({
				url: '<?= site_url('management_barang/satuan_barang/store'); ?>',
				method: 'post',
				dataType: 'json',
		...
		$('#form_edit').on('submit', function(e) {
			...
			$.ajax({
				url: `<?= site_url('management_barang/satuan_barang/update'); ?>/${id_edit}`,
				method: 'post',
				dataType: 'json',
	...
	function processDelete(id) {
		$.ajax({
			url: '<?= site_url('management_barang/satuan_barang/destroy'); ?>',
			method: 'post',
			dataType: 'json',
			data: {
				id: id
