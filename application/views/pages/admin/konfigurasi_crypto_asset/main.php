				...
				<div class="card">
					<div class="card-header">
						...
						<div class="card-tools">
							<a href="<?= site_url('crypto_asset/konfigurasi/add'); ?>" class="btn btn-primary btn-sm">
									...
									?>
											<tr>
												...
												<td class="text-center">
													...
													<a href="<?= site_url('crypto_asset/konfigurasi/destryoy/' . $key['id']); ?>" class="btn btn-danger btn-sm <?= $disabled; ?>">
														Delete
													</a>
												</td>
											</tr>
