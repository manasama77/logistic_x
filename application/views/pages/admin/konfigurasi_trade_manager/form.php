<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Tambah Konfigurasi Trade Manager</h1>
			</div>
			<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-12 col-md-4">
					<div class="form-group">
						<label for="id_package_trade_manager">Paket Trade Manager</label>
						<select class="form-control" id="id_package_trade_manager" name="id_package_trade_manager" required>
							<option value="" selected disabled>-Pilih Paket Trade Manager-</option>
